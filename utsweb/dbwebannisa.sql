...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2942163714ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="210.99">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbwebannisa&table=tb_produk">`dbwebannisa`.`tb_produk`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbwebannisa&table=tb_order">`dbwebannisa`.`tb_order`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbwebannisa&table=tb_katagori">`dbwebannisa`.`tb_katagori`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbwebannisa&table=tb_admin">`dbwebannisa`.`tb_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbmusikannisa&table=tb_album">`dbmusikannisa`.`tb_album`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbmusikannisa&table=tb_user">`dbmusikannisa`.`tb_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbmusikannisa&table=tb_track">`dbmusikannisa`.`tb_track`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbmusikannisa&table=tb_played">`dbmusikannisa`.`tb_played`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbmusikannisa&table=tb_artist">`dbmusikannisa`.`tb_artist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbweb&table=tb_order_detail">`dbweb`.`tb_order_detail`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="56397a33486e224462744c316e56474f">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom field-error" value="210.99"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="dbwebannisa" targettable="tb_katagori">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `tb_katagori` (`kategori_id`, `nama_kategori`) VALUES (&#039;4&#039;, &#039;Hijab Instan&#039;), (&#039;5&#039;, &#039;Jilbab Voal&#039;);</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_katagori`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbwebannisa" targettable="tb_order">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_order`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbwebannisa" targettable="tb_produk">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_produk`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbwebannisa" targettable="tb_produk">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `tb_produk` (`produk_id`, `kategori_id`, `namaproduk`, `harga_produk`, `deskripsi_produk`) VALUES (&#039;4&#039;, &#039;5&#039;, &#039;Paris Voal Motif&#039;, &#039;40000&#039;, &#039;Baru! - 12 Variasi Motif&#039;), (&#039;5&#039;, &#039;4&#039;, &#039;Jersey Sport Instan&#039;, &#039;35000&#039;, &#039;New Product&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbwebannisa" targettable="tb_produk">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `tb_order` (`order_id`, `produk_id`, `jumlahbarang`, `keterangan`) VALUES (&#039;4&#039;, &#039;4&#039;, &#039;122&#039;, &#039;Tersedia&#039;), (&#039;5&#039;, &#039;5&#039;, &#039;200&#039;, &#039;Tersedia&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbwebannisa" targettable="tb_order">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_produk`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="dbwebannisa" targettable="tb_admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
